...
# Generated: Fri Apr 27 01:42:27 2018
##################################################
...
class gfsk_tx(gr.top_block):
    ...
    def __init__(self, baudrate=9600, bin_file_input='/tmp/tx_data.bin', freq=437.5e6, samp_rate_tx=4000000, sdr_dev='rtl=0'):
...
def argument_parser():
    ...
    parser.add_option(
        "-s", "--samp-rate-tx", dest="samp_rate_tx", type="intx", default=4000000,
        help="Set samp_rate [default=%default]")
    parser.add_option(
        "-d", "--sdr-dev", dest="sdr_dev", type="string", default='rtl=0',
        help="Set rtl=0 [default=%default]")
    return parser
