...
# Generated: Fri Aug 10 12:18:13 2018
##################################################
...
class gfsk_rx(gr.top_block):
    ...
    def __init__(self, default_access_code='0000110001010010010011110100001000110011010000010010110101000010', default_bandwidth=20e3, default_baud=9600, default_bin_file_sink="/tmp/rx_data.bin", default_freq=437.5e6, default_gain=1, default_input=0, default_ip_0='127.0.0.1', default_port_0=5000, default_samp=1000000, sdr_dev="rtl=0"):
...
def main(top_block_cls=gfsk_rx, options=None):
    ...
    tb = top_block_cls(default_access_code=options.default_access_code, default_bandwidth=options.default_bandwidth, default_baud=options.default_baud, default_bin_file_sink=options.default_bin_file_sink, default_freq=options.default_freq, default_gain=options.default_gain, default_input=options.default_input, default_ip_0=options.default_ip_0, default_port_0=options.default_port_0, default_samp=options.default_samp, sdr_dev=options.sdr_dev)
    tb.start()
    try:
