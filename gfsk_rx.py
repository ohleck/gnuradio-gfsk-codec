...
# Generated: Thu Aug  9 10:16:20 2018
##################################################
...
class gfsk_rx(gr.top_block):
    ...
    def __init__(self, default_bandwidth=20e3, default_baud=9600, default_bin_file_sink="/tmp/rx_data.bin", default_freq=437.5e6, default_gain=1, default_ip='127.0.0.1', default_port=80, default_samp=1000000, sdr_dev="rtl=0"):
...
def argument_parser():
    ...
    parser.add_option(
        "-p", "--default-port", dest="default_port", type="intx", default=80,
